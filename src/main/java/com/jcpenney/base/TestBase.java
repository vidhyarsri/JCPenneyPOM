...
import com.jcpenney.util.ExtentManager;
import com.jcpenney.util.TestUtil;
...
public class TestBase{
	...
	{
		logger = Logger.getLogger("JCPenney Test");  //getLogger method- Retrieves a logger named according to the value of the name in parameter("JCPenny Test")
