...
public class ExtentManager {
	...
	public static ExtentReports extent; //is used to provide/add information to the HTML report.
	public static ExtentTest extentTest;  //indicate which test to include in the report with logs such as fail, pass and skip
	...
	public static void startReport() 
	{
		...
		htmlReporter.config().setReportName("JCPenney Automation Test Report");  //Title of the report
